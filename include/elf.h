...
#define R_AARCH64_MOVW_SABS_G1                                                                                         \
  271 /* Dir. MOV{DRAM_SIZE,Z} imm. from 31:16.                                                                        \
       */
#define R_AARCH64_MOVW_SABS_G2                                                                                         \
  272                                     /* Dir. MOV{DRAM_SIZE,Z} imm. from 47:32.                                    \
                                           */
...
#define R_AARCH64_LD64_GOTPAGE_LO15                                                                                    \
  313                                         /* GOT-page-rel. GOT off. LD/ST 14:3                                     \
                                               */
...
#define R_AARCH64_TLSLD_ADD_DTPREL_HI12                                                                                \
  528                                             /* DTP-rel. ADD imm. from 23:12.                                     \
                                                   */
...
#define R_AARCH64_TLSLD_LDST128_DTPREL_LO12                                                                            \
  572                                              /* DTP-rel. LD/ST imm. 11:4.                                        \
                                                    */
...
#define R_TILEPRO_IMM16_X0_TLS_GD_HI                                                                                   \
  70 /* X0 pipe high 16-bit TLS GD offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_GD_HI                                                                                   \
  71 /* X1 pipe high 16-bit TLS GD offset                                                                              \
      */
#define R_TILEPRO_IMM16_X0_TLS_GD_HA                                                                                   \
  72 /* X0 pipe ha() 16-bit TLS GD offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_GD_HA                                                                                   \
  73                                    /* X1 pipe ha() 16-bit TLS GD offset                                           \
                                         */
#define R_TILEPRO_IMM16_X0_TLS_IE 74    /* X0 pipe 16-bit TLS IE offset */
#define R_TILEPRO_IMM16_X1_TLS_IE 75    /* X1 pipe 16-bit TLS IE offset */
#define R_TILEPRO_IMM16_X0_TLS_IE_LO 76 /* X0 pipe low 16-bit TLS IE offset */
#define R_TILEPRO_IMM16_X1_TLS_IE_LO 77 /* X1 pipe low 16-bit TLS IE offset */
#define R_TILEPRO_IMM16_X0_TLS_IE_HI                                                                                   \
  78 /* X0 pipe high 16-bit TLS IE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_IE_HI                                                                                   \
  79 /* X1 pipe high 16-bit TLS IE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X0_TLS_IE_HA                                                                                   \
  80 /* X0 pipe ha() 16-bit TLS IE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_IE_HA                                                                                   \
  81                                    /* X1 pipe ha() 16-bit TLS IE offset                                           \
                                         */
...
#define R_TILEPRO_IMM16_X0_TLS_LE_HI                                                                                   \
  89 /* X0 pipe high 16-bit TLS LE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_LE_HI                                                                                   \
  90 /* X1 pipe high 16-bit TLS LE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X0_TLS_LE_HA                                                                                   \
  91 /* X0 pipe ha() 16-bit TLS LE offset                                                                              \
      */
#define R_TILEPRO_IMM16_X1_TLS_LE_HA                                                                                   \
  92 /* X1 pipe ha() 16-bit TLS LE offset                                                                              \
      */
...
#define R_TILEGX_IMM16_X0_HW0_LAST_GOT                                                                                 \
  72 /* X0 pipe last hword 0 GOT offset                                                                                \
      */
#define R_TILEGX_IMM16_X1_HW0_LAST_GOT                                                                                 \
  73 /* X1 pipe last hword 0 GOT offset                                                                                \
      */
#define R_TILEGX_IMM16_X0_HW1_LAST_GOT                                                                                 \
  74 /* X0 pipe last hword 1 GOT offset                                                                                \
      */
#define R_TILEGX_IMM16_X1_HW1_LAST_GOT                                                                                 \
  75                                         /* X1 pipe last hword 1 GOT offset                                        \
                                              */
...
#define R_TILEGX_IMM16_X0_HW0_LAST_TLS_IE                                                                              \
  100 /* X0 pipe last hword 0 IE off                                                                                   \
       */
#define R_TILEGX_IMM16_X1_HW0_LAST_TLS_IE                                                                              \
  101 /* X1 pipe last hword 0 IE off                                                                                   \
       */
#define R_TILEGX_IMM16_X0_HW1_LAST_TLS_IE                                                                              \
  102 /* X0 pipe last hword 1 IE off                                                                                   \
       */
#define R_TILEGX_IMM16_X1_HW1_LAST_TLS_IE                                                                              \
  103 /* X1 pipe last hword 1 IE off                                                                                   \
       */
