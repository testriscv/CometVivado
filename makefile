...
DEFINES=
FILES=cache.cpp core.cpp elfFile.cpp portability.cpp reformeddm_sim.cpp syscalls.cpp
S=./src
S_FILES=$(foreach f, $(FILES), $(S)/$f)
EADER=cache.h core.h elf.h elfFile.h portability.h riscvISA.h syscalls.h
